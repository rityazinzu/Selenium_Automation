...
public class Qiss_dispatcher_locators 
	{
		...
		public static WebElement dv_click_30 (WebDriver driver)
		{
			wait = new WebDriverWait(driver, 15);
			element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[13]/div/div[2]/ul/li[3]")));
			return element;
		}
	}
