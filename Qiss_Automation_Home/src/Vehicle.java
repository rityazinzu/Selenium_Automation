...
public class Vehicle  {
	...
	public void URL() throws InterruptedException, IOException 
	{
		...
		System.out.println("Opening the Qiss test portal -" + driver.getCurrentUrl());
	...
	public void login() throws InterruptedException, IOException 
	{
		...
		try {
			...
			{
				System.out.println("QISS title is shown");
			...
			{
				System.out.println("QISS title is not shown");
