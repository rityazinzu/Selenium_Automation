		...
		public static void call_driver_url() throws InterruptedException, IOException 
			{
				...
				if (driver.getCurrentUrl().contentEquals("https://qiss-test.quipment.nl/home"))
				{
					System.out.println("Qiss test portal opened successfully.");
				...
				{
					System.out.println("Error in loading Qiss test portal");
		...
		public static void login() throws InterruptedException, IOException 
			{
				...
				try {
					...
					String login_username = driver.findElement(By.xpath("//*[@id='RightBar']/div[3]/label[2]")).getText();
					if (driver.getTitle().contentEquals("QISS"))
					{
						System.out.println("Login succesfully with " +login_username);
					...
					{
						System.out.println("Login was not succesfully");
